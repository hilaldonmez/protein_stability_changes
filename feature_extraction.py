...
b62 = generate_dic(b62)
SO_vectors_pam250 = generate_SO_vector(mutations, mutation_info, pr.aa_dict, window_size, pr.len_aa , pam250 , True)
SO_vectors_b62 = generate_SO_vector(mutations, mutation_info, pr.aa_dict, window_size, pr.len_aa , b62, True)
